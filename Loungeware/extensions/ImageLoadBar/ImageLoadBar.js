...
function ImageLoadBar_hook(ctx, width, height, total, current, image) {
	...
	// get parameters:
	var backgroundColor = getc("background_color", "#1f1b25");
	var barBackgroundColor = getc("bar_background_color", "#1f1b25");
	var barForegroundColor = getc("bar_foreground_color", "#2b2438");
	var barBorderColor = getc("bar_border_color", "#2b2438");
	var barWidth = getf("bar_width", Math.round(width * 0.6));
	var barHeight = getf("bar_height", 28);
	var barBorderWidth = getf("bar_border_width", 8);
