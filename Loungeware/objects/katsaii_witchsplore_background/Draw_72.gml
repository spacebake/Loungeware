...
// draw the sun
var sun_angle_blend = lerp(-3, 4, (angle_difference(katsaii_witchsplore_player.angle, 0) + 180) / 360);
...
for (var i = 0; i < array_length(far_islands); i += 1) {
    ...
    var r = island_data[2];
    var angle_blend = lerp(-2, 3, (angle_difference(katsaii_witchsplore_player.angle, angle) + 180) / 360);
