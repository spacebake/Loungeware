/// @description Count, Shadows, Crosshair

#region Crosshair


	if (instance_exists(objfrog_ys_o_cowboy)) {
		var cb = objfrog_ys_o_cowboy;
		var ch_x = cb.x + lengthdir_x(64, cb.direction);
		var ch_y = cb.y - cb.gun_height + lengthdir_y(64, cb.direction);
		draw_sprite(objfrog_ys_s_crosshair, 0, ch_x, ch_y);
	}
