...
___global.gp_to_str[? gp_start] = ___spr_gp_start;	//The start button (this is the "options" button on a PS4 controller)
___global.gp_to_str[? gp_stickl] = ___spr_gp_stickl;	//The left stick pressed (as a button)
___global.gp_to_str[? gp_stickr] = ___spr_gp_stickr;	//The right stick pressed (as a button)
___global.gp_to_str[? gp_padu] = ___spr_gp_padu;	//D-pad up
___global.gp_to_str[? gp_padd] = ___spr_gp_padd;	//D-pad down
___global.gp_to_str[? gp_padl] = ___spr_gp_padl;	//D-pad left
___global.gp_to_str[? gp_padr] = ___spr_gp_padr;	//D-pad right
