...
if wae_missle_counter mod wae_missle_fire_delay == 0 and wae_missle_counter > 70 and not wae_missle_lost
{
...
if wae_missle_counter mod wae_missle_enemy_delay == 0 and not wae_missle_lost
{
	instance_create_layer(x,y,"midground_instances",wae_missle_missle)
}
if wae_missle_counter mod wae_missle_enemy_delay2 == 0 and not wae_missle_lost
{
