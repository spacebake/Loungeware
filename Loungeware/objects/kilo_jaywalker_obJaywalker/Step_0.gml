...
if (x >= 196)
{
	...
	image_speed = 1;
	microgame_win();
	___BUILTIN_AUDIO_PLAY_SOUND(kilo_jaywalker_sndDash,1,false);
}
...
if (place_meeting(x,y,kilo_jaywalker_objCar))
{
	...
	with instance_create_layer(0,room_height,"Overlay",kilo_jaywalker_objResults)
	{
		___BUILTIN_AUDIO_PLAY_SOUND(kilo_jaywalker_sndBonk,1,false);
		___BUILTIN_AUDIO_PLAY_SOUND(kilo_jaywalker_sndLose,1,false);
